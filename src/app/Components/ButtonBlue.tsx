...
const ButtonBlue = ({text}:Props) => {
  return (
    <button className='  rounded-md  px-4 py-1 text-[15px] md:px-8 md:py-2.5 overflow-hidden group bg-blue-500
    relative hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-400 text-white hover:ring-2
